      ...
      builder: (BuildContext context,
        ...
        if (snapshot.hasData) {
          ...
          if (UserController.user.role.first == "ADM") {
            ...
            permissionFilter = data.where((u) => u.tipo.grupo ==
                UserController.user.role.first).toList();
          }


          var filter = permissionFilter.where((u) => u.status == 'aberto')
              .toList();
          total = filter.length;
          ...
          return ListView.builder(
              ...
              itemBuilder: (BuildContext context, int Index) {
                ...
                DateFormat("'Previsão de Entrega:' dd/MM/yyyy").format(
                    now.add(Duration(
                        days: filter[Index].tipo.diasPentregar)));
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          "Nome: ${filter[Index].aluno.name + " " +
                              filter[Index].aluno.lastName}",
                          style: TextStyles.titleListTile,
                        ),
                        Container(
                          height: 16,
  ...
  return FutureBuilder(
      ...
      builder: (BuildContext context,
        ...
        if (snapshot.hasData) {
          ...
          var filter = permissionFilter.where((u) => u.status == 'andando')
              .toList();
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          "Nome: ${snapshot.data![Index].aluno.name + " " +
                              snapshot.data![Index].aluno.lastName}",
                          style: TextStyles.titleListTile,
                        ),
                        Text(
  ...
  return FutureBuilder(
      ...
      builder: (BuildContext context,
        ...
        if (snapshot.hasData) {
          ...
          var filter = permissionFilter.where((u) => u.status == 'concluido')
              .toList();
          ...
          return ListView.builder(
              ...
              itemBuilder: (BuildContext context, int Index) {
                ...
                var formatterOpenDate = new DateFormat(" d'/'MM'/'y 'as' hh:mm");
                String formatted = formatterOpenDate.format(OpenDate);

                var formatterCloseDate = new DateFormat(" d'/'MM'/'y 'as' hh:mm");
